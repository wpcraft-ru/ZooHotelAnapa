...
По умолчанию OpenCode работает как **CEO** проекта Зоогостиница Анапа:
...
- Сайт Зоогостиница Анапа — лендинг для привлечения клиентов.
- Основной продукт — Забота о вашем питомце, пока вы в отъезде.
- Design source: `DESIGN.md` — единый источник истины для токенов.
...
3. Follow the DESIGN.md as source of truth — never contradict it.
4. Avoid broad refactors unless explicitly requested.

## Content rules

- Тон: энергичный, дружелюбный, гостеприимный. Как хороший бармен — неформально, но уважительно.
- SEO: ключевые запросы из `docs/rfc/*.md` использовать органично, не keyword-stuffing.
- Цены: указывать актуальные из меню, с пометкой «не является публичной офертой».
...
- Писать тексты для клиентов живым, энергичным языком
...
- Использовать формальный/корпоративный тон
- Обещать нереалистичные условия
